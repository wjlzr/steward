...
(function ($) {      
    $.fn.date = function (options,Ycallback,Ncallback) {   
        ...
        function refreshDate(){
            ...
            resetInitDete();
            yearScroll.scrollTo(0, initY*45, 100, true);
            monthScroll.scrollTo(0, initM*45-45, 100, true);
            dayScroll.scrollTo(0, initD*45-45, 100, true);
        }
        function refreshTime(){
            ...
            if(initH>12){    //判断当前时间是上午还是下午
                 SecondScroll.scrollTo(0, initD*45-45, 100, true);   //显示“下午”
                 initH=initH-12-1;
            }
            HourScroll.scrollTo(0, initH*45, 100, true);
            MinuteScroll.scrollTo(0, initI*45, 100, true);
        ...
        function CreateDateUI(){
            var str = ''+
                ...
                '<div id="datePage" class="page">'+
                    '<section>'+
                        '<div id="dateconfirm"><h1>完成</h1></div>'+
