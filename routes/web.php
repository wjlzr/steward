...
//插件管理
Route::get('plugin/export/index/{id}', 'Admin\Plugin\ExportController@index');
Route::get('plugin/export/search', 'Admin\Plugin\ExportController@search');
Route::get('plugin/export/download/{id}', 'Admin\Plugin\ExportController@download');
...
Route::middleware(['admin.service'])->group(function () {
    ...
    Route::get('admin/category/sort', 'Admin\Goods\CategoryController@sort');   //设置分类排序
    ...
    Route::post('admin/goods/batch_upload', 'Admin\Goods\GoodsController@batchUpload');  // 批量导入
    Route::get('admin/goods/download', 'Admin\Goods\GoodsController@download');  // 下载商品上传模板
    Route::post('admin/goods/export', 'Admin\Goods\GoodsController@export');  // 导出商品列表
    ...
    Route::post('admin/price/batch_upload', 'Admin\Goods\PriceController@batchUpload');  // 批量上传价格
    ...
    Route::get('admin/mallstock/sync', 'Admin\Goods\MallstockController@sync');  // 同步商品库存
    Route::get('admin/mallstock/batch_stock', 'Admin\Goods\MallstockController@batchStock');  // 批量上传库存
    Route::get('admin/mallstock/download', 'Admin\Goods\MallstockController@download');  // 导出模板
    Route::post('admin/mallstock/batch_upload', 'Admin\Goods\MallstockController@batchUpload');  // 上传
    ...
    Route::post('admin/goods/synch/goodsImport', 'Admin\Goods\GoodsSynchController@goodsImport');
    Route::post('admin/goods/synch/mallImport', 'Admin\Goods\GoodsSynchController@mallImport');
    ...
    Route::get('admin/setting/save', 'Admin\Setting\SettingController@submit'); //保存设置
    ...
    Route::any('admin/mall/batch_upload', 'Admin\Mall\MallController@batchUpload'); //门店上传
    Route::any('admin/mall/export', 'Admin\Mall\MallController@export');
