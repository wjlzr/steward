...
@section('js')
    <script>
        ...
        //                html += '<input class="form-control"  style="width: 200px;" type="text" id="stock_edit" name="stock_edit" maxlength="100" value="'+ stock +'" />';
        //                html += '</div>';
        //                html += '</div>';
        //                html += '<div class="col-sm-12" style="margin-top: 8px">'
        //                html += '<input type="button" class="btn btn-blue" onclick="popover.save();" value="确定"  style="margin-right: 20px; width: 75px;"/>';
        //                html += '<input type="button" class="btn btn-default" style="width: 75px;" onclick="popover.cancel();" value="取消"/>';
        //                html += '</div>';
        //                html += '</div>';
        //                html += '</div>';
        //
        ...
        $(document).on('click', '.import', function () {
            ...
            {{--html += '<form id="import_data_form" name="upload_form" action="/admin/mall/batch_upload" enctype="multipart/form-data">';--}}
            ...
            {{--html += '<input value="上传文件" class="btn btn-blue" id="import_file" type="button">';--}}
            {{--html += '</span>';--}}
            {{--html += '<span style="display: inline-block;margin-left: 20px">';--}}
