...
K.options = {
	...
	zIndex : 811213,
	items : [
		'source','preview', 'fullscreen','|','fontname', 'fontsize', '|', 'forecolor', 'hilitecolor', 'bold',
		'italic' , 'underline' , 'lineheight' , 'removeformat', '|', 'image', 'multiimage',
		'flash' , 'media' , 'table' , 'emoticons' , 'link', 'unlink', '|' ,'couponCode'
	],
	...
	htmlTags : {
        input: ['type', 'id', 'class', 'style', 'maxlength', 'value'],
        style: ['type'],
        'canvas,button,em,span,div' : ['id', 'class', 'style', 'width', 'height','onclick'],
		font : ['id', 'class', 'color', 'size', 'face', 'style'],
		table: [
			'id', 'class', 'border', 'cellspacing', 'cellpadding', 'width', 'height', 'align', 'bordercolor', 'style'
		],
		'td,th': [
			'id', 'class', 'align', 'valign', 'width', 'height', 'colspan', 'rowspan', 'bgcolor', 'style'
		],
		a : ['id', 'class', 'href', 'target', 'name', 'style', 'onclick'],
		embed : ['id', 'class', 'src', 'width', 'height', 'type', 'loop', 'autostart', 'quality', 'align', 'allowscriptaccess', 'style'],
		img : ['id', 'class', 'src', 'width', 'height', 'border', 'alt', 'title', 'align', 'style'],
		'p,ol,ul,li,blockquote,h1,h2,h3,h4,h5,h6' : [
			'id', 'class', 'align', 'style','onclick'
		],
		'br,tbody,tr,strong,b,sub,sup,em,i,u,strike,s,del,pre,hr,form' : ['id', 'class', 'style','onclick'],
		iframe : ['id', 'class', 'src', 'frameborder', 'width', 'height', 'style']
	},
