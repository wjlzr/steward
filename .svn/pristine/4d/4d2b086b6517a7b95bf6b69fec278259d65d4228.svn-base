...
namespace App\Services\Core\Index;
...
class IndexSearchService
{
    ...
    public function orderStatusCount($date = 0, $mall_id = 0)
    {
        ...
        $return_result = [
            ...
            'cancel_orders' => app_to_int($cancel_orders)
        ];
