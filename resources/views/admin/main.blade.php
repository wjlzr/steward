    ...
    <script>
        ...
        function order_prompts() {
            ...
            $.ajax({
                ...
                dataType:'json',
                success : function(obj){
                    count_fresh(obj.data.new_number, obj.data.remind_number, obj.data.refund_number);
                }
            });
        ...
        function jump_notice(type) {
            $('#main-frame').attr('src', '/admin/order?anchor=' + type);
        }
