...
//                    console.log(this); //当前排序的 th 对象
        ...
        var layui_table_ajax_url = '/admin/mall/balance/list';

        layui_table({
            sort_name : 'toal_goods_money',
            sort_order : 'desc',
            method : 'get',
            cols: [[
                {title: "门店", field : "mall_name", width: '13%', align: "center"},
                {title: "渠道", field : "app_name", width: '12%', align: "center"},
                {title: "商品金额(元)", field : "toal_goods_money", width: '12%', align: "center",sort:true},
                {title: "商家优惠(元)", field : "toal_mall_discount_money", width: '11%', align: "center"},
                {title: "平台优惠(元)", field : "toal_app_discount_money", width: '11%',align:"center"},
                {title: "收入(元)", field : "total_income", width: '10%',align:"center"},
                {title: "退货(元)", field : "total_return_money", width: '10%',align:"center"},
                {title: "包装(元)", field : "total_package_money", width: '10%',align:"center"},
                {title: "实际结算(元)", field : "bill_money", width: '11%',align:"center"}
            ]]
        });
